...
public class InstructionInfo implements Comparable<InstructionInfo> {
    ...
    private static Map<InstructionName, InstructionInfo> generateInstructionNameToInstructionMap()
    {
        ...
        map.put(InstructionName.ADDI, 	new InstructionInfo("ADDI",	2,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.ADDUI, 	new InstructionInfo("ADDUI",	3,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.ANDI, 	new InstructionInfo("ANDI",	4,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.BEQZ, 	new InstructionInfo("BEQZ",	5,	0,	InstructionType.REGLAB,	0));
        map.put(InstructionName.BFPF, 	new InstructionInfo("BFPF",	6,	0,	InstructionType.LEXP16,	0));
        map.put(InstructionName.BFPT, 	new InstructionInfo("BFPT",	7,	0,	InstructionType.LEXP16,	0));
        map.put(InstructionName.BNEZ, 	new InstructionInfo("BNEZ",	8,	0,	InstructionType.REGLAB,	0));
        map.put(InstructionName.J, 	    new InstructionInfo("J",	9,	0,	InstructionType.LEXP26,	0));
        map.put(InstructionName.JAL, 	new InstructionInfo("JAL",	10,	0,	InstructionType.LEXP26,	0));
        map.put(InstructionName.JALR, 	new InstructionInfo("JALR",	11,	0,	InstructionType.IREG1,	0));
        map.put(InstructionName.JR, 	new InstructionInfo("JR",	12,	0,	InstructionType.IREG1,	0));
        map.put(InstructionName.LB, 	new InstructionInfo("LB",	13,	0,	InstructionType.LOADI,	0));
        map.put(InstructionName.LBU, 	new InstructionInfo("LBU",	14,	0,	InstructionType.LOADI,	0));
        map.put(InstructionName.LD, 	new InstructionInfo("LD",	15,	0,	InstructionType.LOADD,	0));
        map.put(InstructionName.LF, 	new InstructionInfo("LF",	16,	0,	InstructionType.LOADF,	0));
        map.put(InstructionName.LH, 	new InstructionInfo("LH",	17,	0,	InstructionType.LOADI,	0));
        map.put(InstructionName.LHI, 	new InstructionInfo("LHI",	18,	0,	InstructionType.REG1IMM,	0));
        map.put(InstructionName.LHU, 	new InstructionInfo("LHU",	19,	0,	InstructionType.LOADI,	0));
        map.put(InstructionName.LW, 	new InstructionInfo("LW",	20,	0,	InstructionType.LOADI,	0));
        map.put(InstructionName.ORI, 	new InstructionInfo("ORI",	21,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.RFE, 	new InstructionInfo("RFE",	22,	0,	InstructionType.UNIMP,	0));
        map.put(InstructionName.SB, 	new InstructionInfo("SB",	23,	0,	InstructionType.STRI,	0));
        map.put(InstructionName.SD, 	new InstructionInfo("SD",	24,	0,	InstructionType.STRD,	0));
        map.put(InstructionName.SEQI, 	new InstructionInfo("SEQI",	25,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SF, 	new InstructionInfo("SF",	26,	0,	InstructionType.STRF,	0));
        map.put(InstructionName.SGEI, 	new InstructionInfo("SGEI",	27,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SGEUI, 	new InstructionInfo("SGEUI",	28,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SGTI, 	new InstructionInfo("SGTI",	29,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SGTUI, 	new InstructionInfo("SGTUI",	30,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SH, 	new InstructionInfo("SH",	31,	0,	InstructionType.STRI,	0));
        map.put(InstructionName.SLEI, 	new InstructionInfo("SLEI",	32,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SLEUI, 	new InstructionInfo("SLEUI",	33,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SLLI, 	new InstructionInfo("SLLI",	34,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SLTI, 	new InstructionInfo("SLTI",	35,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SLTUI, 	new InstructionInfo("SLTUI",	36,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SNEI, 	new InstructionInfo("SNEI",	37,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SRAI, 	new InstructionInfo("SRAI",	38,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SRLI, 	new InstructionInfo("SRLI",	39,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SUBI, 	new InstructionInfo("SUBI",	40,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SUBUI, 	new InstructionInfo("SUBUI",	41,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.SW, 	new InstructionInfo("SW",	42,	0,	InstructionType.STRI,	0));
        map.put(InstructionName.TRAP, 	new InstructionInfo("TRAP",	43,	0,	InstructionType.IMM1,	0));
        map.put(InstructionName.XORI, 	new InstructionInfo("XORI",	44,	0,	InstructionType.REG2IMM,	0));
        map.put(InstructionName.LA, 	new InstructionInfo("LA",	48,	0,	InstructionType.PSEUDO,	0));
        map.put(InstructionName.NOP, 	new InstructionInfo("NOP",	0,	0,	InstructionType.NONEOP,	0));
        map.put(InstructionName.ADD, 	new InstructionInfo("ADD",	0,	1,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.ADDU, 	new InstructionInfo("ADDU",	0,	2,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.AND, 	new InstructionInfo("AND",	0,	3,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.MOVD, 	new InstructionInfo("MOVD",	0,	4,	InstructionType.DREG2a,	0));
        map.put(InstructionName.MOVF, 	new InstructionInfo("MOVF",	0,	5,	InstructionType.FREG2a,	0));
        map.put(InstructionName.MOVFP2I, 	new InstructionInfo("MOVFP2I",	0,	6,	InstructionType.IF2,	0));
        map.put(InstructionName.MOVI2FP, 	new InstructionInfo("MOVI2FP",	0,	7,	InstructionType.FI2,	0));
        ...
        map.put(InstructionName.OR, 	new InstructionInfo("OR",	0,	10,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SEQ, 	new InstructionInfo("SEQ",	0,	11,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SGE, 	new InstructionInfo("SGE",	0,	12,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SGEU, 	new InstructionInfo("SGEU",	0,	13,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SGT, 	new InstructionInfo("SGT",	0,	14,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SGTU, 	new InstructionInfo("SGTU",	0,	15,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SLE, 	new InstructionInfo("SLE",	0,	16,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SLEU, 	new InstructionInfo("SLEU",	0,	17,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SLL, 	new InstructionInfo("SLL",	0,	18,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SLT, 	new InstructionInfo("SLT",	0,	19,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SLTU, 	new InstructionInfo("SLTU",	0,	20,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SNE, 	new InstructionInfo("SNE",	0,	21,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SRA, 	new InstructionInfo("SRA",	0,	22,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SRL, 	new InstructionInfo("SRL",	0,	23,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SUB, 	new InstructionInfo("SUB",	0,	24,	InstructionType.REG3IMM,	0));
        map.put(InstructionName.SUBU, 	new InstructionInfo("SUBU",	0,	25,	InstructionType.REG3IMM,	0));
        ...
        map.put(InstructionName.DIVF, 	new InstructionInfo("DIVF",	1,	10,	InstructionType.FREG3,	0));
        map.put(InstructionName.DIVU, 	new InstructionInfo("DIVU",	1,	11,	InstructionType.FREG3,	0));
        map.put(InstructionName.EQD, 	new InstructionInfo("EQD",	1,	12,	InstructionType.DREG2b,	0));
        map.put(InstructionName.EQF, 	new InstructionInfo("EQF",	1,	13,	InstructionType.FREG2b,	0));
        map.put(InstructionName.GED, 	new InstructionInfo("GED",	1,	14,	InstructionType.DREG2b,	0));
        map.put(InstructionName.GEF, 	new InstructionInfo("GEF",	1,	15,	InstructionType.FREG2b,	0));
        map.put(InstructionName.GTD, 	new InstructionInfo("GTD",	1,	16,	InstructionType.DREG2b,	0));
        map.put(InstructionName.GTF, 	new InstructionInfo("GTF",	1,	17,	InstructionType.FREG2b,	0));
        map.put(InstructionName.LED, 	new InstructionInfo("LED",	1,	18,	InstructionType.DREG2b,	0));
        map.put(InstructionName.LEF, 	new InstructionInfo("LEF",	1,	19,	InstructionType.FREG2b,	0));
        map.put(InstructionName.LTD, 	new InstructionInfo("LTD",	1,	20,	InstructionType.DREG2b,	0));
        map.put(InstructionName.LTF, 	new InstructionInfo("LTF",	1,	21,	InstructionType.FREG2b,	0));
        map.put(InstructionName.MULT, 	new InstructionInfo("MULT",	1,	22,	InstructionType.FREG3,	0));
        map.put(InstructionName.MULTD, 	new InstructionInfo("MULTD",	1,	23,	InstructionType.DREG3,	0));
        map.put(InstructionName.MULTF, 	new InstructionInfo("MULTF",	1,	24,	InstructionType.FREG3,	0));
        map.put(InstructionName.MULTU, 	new InstructionInfo("MULTU",	1,	25,	InstructionType.FREG3,	0));
        map.put(InstructionName.NED, 	new InstructionInfo("NED",	1,	26,	InstructionType.DREG2b,	0));
        map.put(InstructionName.NEF, 	new InstructionInfo("NEF",	1,	27,	InstructionType.FREG2b,	0));
        map.put(InstructionName.SUBD, 	new InstructionInfo("SUBD",	1,	28,	InstructionType.DREG3,	0));
